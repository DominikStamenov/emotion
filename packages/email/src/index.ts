...
function emailFrame(content: string) {
  return [
    ...
    content,
    "</td></tr><tr><td style='padding:24px 38px;color:#8a867d;background:#171715;border-radius:0 0 18px 18px;font-size:12px'>eMotion · project communication</td></tr>",
  ...
  return {
    ...
    html: emailFrame(
      "<p style='margin:0 0 8px;color:#78746d;font-size:11px;letter-spacing:.12em;text-transform:uppercase'>Project brief received</p>" +
        ...
        ".</h1><p style='margin:0;color:#5f5c56;font-size:15px;line-height:1.7'>Your brief is safely in our workspace. We will review the context and reply to the e-mail address you provided. No automated proposal, no generic sales sequence — a real person will continue the conversation.</p>",
    ),
    text:
      "Thank you, " +
      data.name +
      ". Your project brief is safely in our workspace. We will review it and reply to the e-mail address you provided.",
  };
}
